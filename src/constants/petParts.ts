...
// to palette colors at compose time. Eye/mouth/accessory patches are tiny
// pixel grids that get stamped onto the silhouette.
//
...
export type Accessory = 'none' | 'horn' | 'antenna' | 'leaf' | 'hat';
...
export const BODY_SHAPES: Record<BodyShape, { baby: TokenGrid; grown: TokenGrid }> = {
  round: {
    baby: [
      ...
      [null, null, 'O', 'O', null, null, null, null, 'O', 'O', null, null],
    ...
    grown: [
      ...
      [null, 'O', 'O', null, null, null, null, null, null, 'O', 'O', null],
    ],
  },
  tall: {
    baby: [
      ...
      [null, null, 'O', null, null, null, null, null, 'O', null, null, null],
    ],
    grown: [
      [null, null, 'O', 'O', 'O', 'O', 'O', 'O', 'O', null, null, null],
      [null, 'O', 'B', 'B', 'B', 'B', 'B', 'B', 'B', 'O', null, null],
  ...
  blob: {
    ...
    grown: [
      ...
      [null, 'O', 'O', 'B', 'B', 'B', 'B', 'B', 'B', 'O', 'O', null],
      [null, null, 'O', 'O', 'O', 'O', 'O', 'O', 'O', 'O', null, null],
      [null, null, 'O', 'O', null, null, null, 'O', 'O', null, null, null],
    ],
  },
  square: {
    baby: [
...
// Accessory patches anchored at top of body. width 4, height 2.
export type AccToken = 'O' | 'B' | 'D' | 'C' | 'A' | null; // A = accent (special)
export const ACCESSORY_PATCHES: Record<Accessory, AccToken[][]> = {
  none: [],
  horn: [
    [null, 'O', null, null],
    [null, 'A', 'O', null],
...
export const PALETTES: Record<PaletteName, Palette> = {
  yellow: { body: '#f0d060', bodyDark: '#c9a93f', cheek: '#ff8fab', outline: '#2d2d2d', accent: '#ff7a59' },
  mint:   { body: '#9ee5b5', bodyDark: '#5fb381', cheek: '#ff8fab', outline: '#234134', accent: '#ffd166' },
  sky:    { body: '#a0d2ff', bodyDark: '#5b9be0', cheek: '#ff9ab2', outline: '#1f3a5f', accent: '#ffd166' },
  pink:   { body: '#ffb3c6', bodyDark: '#d97a93', cheek: '#ff5d8f', outline: '#4a1d2c', accent: '#fff1a8' },
  lilac:  { body: '#cdb4ff', bodyDark: '#8e72d8', cheek: '#ff8fab', outline: '#2f1f54', accent: '#a8f0e0' },
  peach:  { body: '#ffc28a', bodyDark: '#d28b50', cheek: '#ff7a91', outline: '#4a2914', accent: '#88e1c8' },
};

export const BODY_SHAPE_KEYS: readonly BodyShape[] = ['round', 'tall', 'blob', 'square'];
export const EYE_KEYS: readonly EyeStyle[] = ['dot', 'oval', 'sleepy', 'sparkle', 'cross'];
export const MOUTH_KEYS: readonly MouthStyle[] = ['smile', 'dot', 'fang', 'wavy'];
export const ACCESSORY_KEYS: readonly Accessory[] = ['none', 'horn', 'antenna', 'leaf', 'hat'];
export const PALETTE_KEYS: readonly PaletteName[] = ['yellow', 'mint', 'sky', 'pink', 'lilac', 'peach'];
